...
import SEOHead, { createBreadcrumbSchema, createArticleSchema, createHowToSchema } from '@/components/seo/SEOHead';
...
const ARTICLES = {
  // Vinyl Liners
  "how-to-choose-pool-liner-pattern": {
    category: "vinyl-liners",
    categoryName: "Vinyl Pool Liners",
  ...
  "vinyl-liner-thickness-durability": {
    category: "vinyl-liners",
    categoryName: "Vinyl Pool Liners",
  ...
  "pool-liner-installation-diy-vs-professional": {
    category: "vinyl-liners",
    categoryName: "Vinyl Pool Liners",
  ...
  "vinyl-liner-water-chemistry-lifespan": {
    category: "vinyl-liners",
    categoryName: "Vinyl Pool Liners",
  ...
  // Safety Covers
  "astm-f1346-safety-standards-explained": {
    category: "safety-covers",
    categoryName: "Safety Pool Covers",
  ...
  "mesh-vs-solid-safety-covers": {
    ...
    paragraphs: [
      ...
      "Mesh covers allow rain and snow melt to drain through while blocking 95–99% of sunlight to prevent algae growth. They're significantly lighter than solid covers, making installation and removal much easier. In regions with heavy snowfall and precipitation, mesh covers excel because they never accumulate dangerous amounts of standing water on their surface.",
      "Our Premier Mesh (18-year warranty) delivers 500 psi burst strength with 95%+ sun block. Our Deluxe Mesh (20-year warranty) upgrades to 670 psi burst strength and 99% sun block with a tighter weave that keeps finer debris out. Our Commercial Mesh (30-year warranty) achieves 760 psi burst strength — the highest-strength mesh available anywhere.",
      "Solid covers block 100% of light and all debris, keeping pool water significantly cleaner through winter. This means faster, easier pool openings in spring with less algae treatment required. However, solid covers require a drain panel or submersible cover pump to manage rain and snow melt accumulation.",
      "Our LW Solid (15-year warranty, 7.5oz copolymer) and Solid Safety Cover (15-year warranty, 12oz PVC) options both come with optional mesh drain panels. In areas with heavy deciduous trees, solid covers often pay for themselves in reduced opening costs — less algae treatment, less vacuuming, and cleaner water from the first day of swimming season.",
    ],
  },
  "safety-cover-installation-anchoring-guide": {
    category: "safety-covers",
    categoryName: "Safety Pool Covers",
  ...
  "year-round-pool-safety": {
    ...
    image: null,
    paragraphs: [
      "While safety covers are essential for off-season protection, comprehensive pool safety requires a year-round strategy that addresses multiple risk factors. Drowning remains a leading cause of accidental death for children under five, and the majority of incidents occur in residential pools.",
      "Install proper pool fencing — at least 4 feet high with self-closing, self-latching gates — to create an independent barrier around the pool area. Fencing should be designed so children cannot climb it, with no horizontal footholds below the latch. This perimeter barrier is the single most effective drowning prevention measure.",
      "Use pool alarms as secondary safety layers. Subsurface alarms detect water disturbance caused by entry into the pool and sound loud alerts inside and outside the home. Gate alarms notify you when pool access gates are opened unexpectedly.",
      "Establish clear pool rules and enforce them consistently — no unsupervised swimming, no running on deck, no diving in shallow areas. Designate a dedicated adult supervisor whenever the pool is in use. Keep rescue equipment easily accessible at poolside at all times.",
      "Learn CPR and ensure family members and frequent visitors are also trained. When seconds matter, the ability to provide immediate rescue breathing dramatically improves outcomes. Combine physical barriers, alarms, supervision, and emergency preparedness for the most comprehensive pool safety approach possible.",
    ],
  },
  // Solar Covers
  "science-behind-solar-pool-heating": {
    category: "solar-covers",
    categoryName: "Solar Pool Covers",
    ...
    paragraphs: [
      ...
      "The bubble design on the underside of the cover acts like thousands of tiny concentrating lenses, focusing sunlight and maximizing the heat transfer into the water below. Air trapped in each bubble provides insulation — the same way a double-pane window is warmer than single glass.",
      "Our Thermo Shield™ blue/black design takes this a step further by using dark coloration to absorb a broader spectrum of solar radiation, potentially raising water temperature 25% more than conventional clear covers. Dark surfaces absorb more heat than reflective surfaces — making Thermo Shield™ particularly effective in northern climates with cooler summers.",
      "During the day, covers can increase pool temperature by 8–15°F depending on climate, sun intensity, and pool size. At night, the insulating bubbles prevent the 5–10°F temperature drop that typically occurs as pools radiate heat into cool night air.",
      "The practical result is that pool owners in most North American climates can extend their swimming season by 4–8 weeks with consistent solar cover use — gaining meaningful extra weeks at both ends of the season without any additional heating equipment or operating costs.",
    ],
  },
  "maximizing-energy-savings-solar-covers": {
    category: "solar-covers",
    categoryName: "Solar Pool Covers",
    ...
    paragraphs: [
      ...
      "The single most effective habit is putting the cover on every evening without exception. Night hours represent peak heat loss: cooler air temperatures, wind, and the absence of solar input all conspire to cool pool water rapidly. A pool left uncovered overnight in cool weather can lose 5–10°F by morning.",
      "Invest in a quality reel system, and solar cover use will become effortless rather than a chore. Studies consistently show that pool owners with properly installed reel systems use their covers 60–80% more consistently than those who fold and store covers manually.",
      "Cut your cover to fit as precisely as possible, leaving minimal gaps around the perimeter. Every gap is a pathway for heat loss and evaporation. Combine solar covers with pool insulation products like Insul-Floor and Thermo-Wall for even greater whole-system efficiency.",
      "Track your utility bills and pool chemical consumption before and after implementing consistent solar cover use. Most pool owners see payback on their cover investment within the first season from reduced heating costs alone.",
    ],
  },
  "solar-covers-reduce-evaporation-chemical-costs": {
    category: "solar-covers",
    categoryName: "Solar Pool Covers",
    ...
    paragraphs: [
      "Water evaporation is one of the most underappreciated ongoing costs of pool ownership. An uncovered pool can lose 1–2 inches of water every week during summer — translating to 7,000–15,000 gallons annually for an average-sized pool.",
      "Solar covers prevent up to 95% of this evaporation, acting as a physical barrier between the pool surface and the air above. The result is dramatically reduced water consumption, lower water bills, and less stress on municipal water supplies.",
      "Beyond water savings, evaporation carries dissolved chemicals out of the pool along with the water vapor — primarily chlorine and other sanitizers. By minimizing evaporation, covers reduce chemical consumption by 35–60%.",
      "More stable water chemistry also means better protection for your pool liner, equipment, and surfaces. Fluctuating chemical levels stress all pool components over time. A pool with consistent chemistry will have longer-lasting equipment and cleaner, clearer water with less effort.",
      "When you combine heating savings, reduced water consumption, chemical savings, and extended swimming season, the annual financial benefit of consistent solar cover use typically ranges from $500–$1,500 depending on pool size and climate.",
    ],
  },
  "solar-cover-care-storage-lifespan": {
    category: "solar-covers",
    categoryName: "Solar Pool Covers",
    ...
    paragraphs: [
      ...
      "Never place chlorine tablets, granules, or other chemicals directly on the solar cover. Even briefly, concentrated chemical contact degrades the plastic bubbles and causes brittle, flaking breakdown that is irreversible. Always add chemicals to the pool with the cover removed.",
      "Handle covers gently during removal and replacement. Dragging across rough concrete or stone deck surfaces causes physical abrasion that progressively weakens the material. Use a reel system for daily operation — it protects the cover from deck contact while making use effortlessly convenient.",
      "For storage during extended non-use periods, clean the cover thoroughly, allow it to dry completely, then roll loosely and store in a cool, shaded location. Never store covers in airtight containers — trapped moisture promotes mildew growth that deteriorates the material.",
      "Inspect your cover each spring before first use. Look for deteriorating bubbles, holes, or tears, and repair small damage immediately using patch kits. With proper care, our Solar-Extreme™ and Thermo Shield™ products consistently meet and exceed their rated lifespan.",
    ],
  },
  // Winter Covers
  "complete-pool-winterization-guide": {
    category: "winter-covers",
    categoryName: "Winter Pool Covers",
    ...
    paragraphs: [
      "Successful winter pool protection is a process that begins well before the cover goes on. Skipping or rushing winterization steps is the most common cause of costly spring surprises — green water, damaged equipment, and expensive repairs that could have been entirely prevented with a systematic closing approach.",
      "Begin by thoroughly cleaning the pool — vacuum the floor, brush walls and steps, and empty all skimmer baskets. Balance water chemistry carefully: pH 7.2–7.6, total alkalinity 80–120 ppm, calcium hardness 180–220 ppm.",
      "Shock the pool with 2–3 times the normal chlorine dose to eliminate contaminants and build up a residual that will carry through the early winter weeks. Add winter algaecide following manufacturer instructions.",
      "Drain and blow out all plumbing lines using a shop vacuum or air compressor to eliminate standing water that could freeze and crack pipes. Remove and winterize the pump, filter, and heater according to their individual manufacturer instructions.",
      "Lower water level 4–6 inches below skimmer openings for in-ground pools, install skimmer plugs and expansion compensators, and remove all pool accessories. Only after completing all these steps should you install your winter cover.",
    ],
  },
  "winter-cover-materials-construction-quality": {
    category: "winter-covers",
    categoryName: "Winter Pool Covers",
    ...
    paragraphs: [
      "Not all winter covers are created equal, and the differences become apparent only when your pool faces the conditions these covers are designed to withstand — heavy snow loads, ice formation, high winds, and months of UV exposure.",
      "Covertech's Superior Winter Cover uses rip-stop fabric technology — the same weaving technique used in parachutes, premium outdoor gear, and military equipment. Reinforced threads woven at regular intervals stop any rip or tear from propagating across the material.",
      "Our covers feature UV-stabilized coating that resists the degradation caused by months of winter sun exposure. Many budget covers develop brittleness and cracking within 2–3 seasons from UV breakdown alone.",
      "Reinforced grommets with stainless steel or brass construction resist corrosion through multiple winter seasons. Cable and winch systems are engineered to compatible tension specifications — our hardware is matched to the tensile strength of the cover fabric for a balanced, long-lasting system.",
      "The 15-year warranty on our Superior Winter Cover reflects genuine confidence in these engineering choices. When you calculate cost per year of use, premium covers consistently prove more economical than budget alternatives that require replacement every few seasons.",
    ],
  },
  "managing-snow-ice-pool-cover": {
    category: "winter-covers",
    categoryName: "Winter Pool Covers",
    ...
    paragraphs: [
      "A properly installed winter cover requires active management during severe weather events to maintain its protective function and prevent damage. While covers are designed to withstand significant loads, proactive maintenance after storms extends cover life and ensures it performs as intended.",
      "Light snow accumulation — generally under 4 inches — can remain on the cover without concern. Heavier accumulation should be removed to reduce stress on the cover material and anchor system. Use a soft push broom or purpose-designed pool cover rake to sweep snow toward the edges.",
      "For icy surfaces, patience is your best tool. Wait for slight melting before attempting removal — forcing ice off a cover risks taking cover material with it. Light application of pool-safe de-icer around the perimeter anchors can help free frozen hardware.",
      "Water accumulation on solid covers requires a submersible cover pump designed specifically for this purpose. When water depth exceeds 2 inches anywhere on the cover surface, deploy the pump to remove the excess.",
      "Check your cover after every significant storm. This 10-minute inspection habit catches developing problems before they become expensive failures — a loosening anchor, a small tear starting at a grommet, or a cable beginning to fray.",
    ],
  },
  "spring-pool-opening-cover-removal": {
    category: "winter-covers",
    categoryName: "Winter Pool Covers",
    ...
    paragraphs: [
      "Spring opening is the payoff for a well-executed fall winterization — a pool that opens clean, clear, and ready for the season within days rather than weeks. Cover removal done correctly protects both the cover for future seasons and the pool water from contamination.",
      "Begin cover removal by pumping off all standing water from the cover surface until it is as dry as possible. Then carefully sweep remaining debris toward the edges, working from the center outward. This prevents you from dumping a season's worth of winter debris directly into your pool water.",
      "Remove cover anchors systematically from one end of the pool and enlist helpers for the actual removal. Fold the cover accordion-style from one end, keeping the dirty upper surface folded inward to contain any residual debris. Never drag the cover across coping or rough deck surfaces.",
      "Once removed, spread the cover on a clean grass or deck area and wash thoroughly with a garden hose and mild soap. Inspect every inch for tears, weakened areas, loose grommets, or worn spots. Small repairs made now prevent those issues from becoming full failures next fall.",
      "Fold or roll loosely and store in the provided bag in a cool, dry location with air circulation — never seal in airtight plastic bags. Keep away from rodents, sharp objects, and chemical storage areas. A properly stored cover will arrive next fall in ready-to-install condition.",
    ],
  },
};

const CATEGORY_SLUGS = {
  "vinyl-liners": ["how-to-choose-pool-liner-pattern", "vinyl-liner-thickness-durability", "pool-liner-installation-diy-vs-professional", "vinyl-liner-water-chemistry-lifespan"],
  "safety-covers": ["astm-f1346-safety-standards-explained", "mesh-vs-solid-safety-covers", "safety-cover-installation-anchoring-guide", "year-round-pool-safety"],
  "solar-covers": ["science-behind-solar-pool-heating", "maximizing-energy-savings-solar-covers", "solar-covers-reduce-evaporation-chemical-costs", "solar-cover-care-storage-lifespan"],
  "winter-covers": ["complete-pool-winterization-guide", "winter-cover-materials-construction-quality", "managing-snow-ice-pool-cover", "spring-pool-opening-cover-removal"],
};

export { ARTICLES, CATEGORY_SLUGS };
...
export default function LearnArticle() {
  ...
  if (!article) {
    return (
      <div className="pt-32 pb-16 text-center">
        ...
        <Link to={createPageUrl('Learn')} className="text-cyan-600 hover:underline mt-4 block">← Back to Learn</Link>
      </div>
    );
  }

  const categorySlugs = CATEGORY_SLUGS[article.category];
  const currentIndex = categorySlugs.indexOf(slug);
  const prevSlug = currentIndex > 0 ? categorySlugs[currentIndex - 1] : null;
  const nextSlug = currentIndex < categorySlugs.length - 1 ? categorySlugs[currentIndex + 1] : null;

  const pageUrl = `https://covertechind.com/LearnArticle?slug=${slug}`;
  const breadcrumb = createBreadcrumbSchema([
    { name: "Home", url: "https://covertechind.com" },
    { name: "Learn", url: "https://covertechind.com/Learn" },
    { name: article.categoryName, url: `https://covertechind.com/Learn` },
  ...
  const howToSchema = article.paragraphs.length >= 3 ? createHowToSchema({
    name: article.title,
    description: article.excerpt || article.paragraphs[0].substring(0, 160),
    image: article.image,
    steps: article.paragraphs,
  }) : null;

  return (
    <>
      <SEOHead
        title={`Covertech | ${article.title}`}
        description={article.excerpt || article.paragraphs[0].substring(0, 160)}
        canonicalUrl={pageUrl}
        ogImage={article.image || "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6966301493bec01d4fb29d56/51ca60482_01-Liner.jpg"}
        keywords={[article.categoryName, "Covertech Industries", "pool products Canada", article.title]}
        schema={[breadcrumb, articleSchema, ...(howToSchema ? [howToSchema] : [])]}
      />
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <nav className="flex items-center gap-2 text-sm text-slate-500 mb-10">
          <Link to={createPageUrl('Learn')} className="hover:text-cyan-600">Learn</Link>
          <span>/</span>
        ...
        <article className="prose prose-lg prose-slate max-w-none">
          {article.excerpt && (
            <p className="text-xl text-cyan-700 font-medium leading-relaxed mb-8 not-prose">{article.excerpt}</p>
          )}
        ...
        <div className="flex items-center justify-between mt-16 pt-8 border-t border-slate-200">
          {prevSlug ? (
            <Link to={createPageUrl(`LearnArticle?slug=${prevSlug}`)} className="flex items-center gap-2 text-cyan-600 hover:text-cyan-700 font-medium group">
              <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
              <span className="hidden sm:inline">{ARTICLES[prevSlug]?.title}</span>
              <span className="sm:hidden">Previous</span>
            </Link>
          ) : <div />}
          {nextSlug ? (
            <Link to={createPageUrl(`LearnArticle?slug=${nextSlug}`)} className="flex items-center gap-2 text-cyan-600 hover:text-cyan-700 font-medium group">
              <span className="hidden sm:inline">{ARTICLES[nextSlug]?.title}</span>
